...
const hqBlock = 42
let distanceFromHq = 0 
function distanceFromHqInBlocks(starterBlock){
     if (starterBlock > 42){
        distanceFromHq = starterBlock - hqBlock
     }
     else {
        distanceFromHq = hqBlock - starterBlock
     }
     return distanceFromHq
}
let feetfromHQ
function distanceFromHqInFeet(starterBlock){
    distanceFromHqInBlocks(starterBlock)
    feetfromHQ = distanceFromHq * 264
    return feetfromHQ
}
